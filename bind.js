...
//Польза от этого в том, что возможно создать независимую функцию с
// понятным названием (double, triple).
//В других случаях частичное применение полезно,
// когда у нас есть очень общая функция и
// для удобства мы хотим создать её более специализированный вариант.
